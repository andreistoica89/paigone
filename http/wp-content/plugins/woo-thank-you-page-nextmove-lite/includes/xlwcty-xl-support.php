		...
		if ( is_array( $other_products ) && count( $other_products ) > 0 ) {
			...
			if ( true === $easter_offer ) {
                ...
                <div class="postbox xlwcty_side_content xlwcty_xlplugins xlwcty_xlplugins_bundle">
                    ...
                    <div class="xlwcty_plugin_head">Considering Finale? Here's a great deal for you!</div>
                    <div class="xlwcty_plugin_desc">Get up to <strong><u>20% off</u></strong> on our bundles. Club our best-seller Finale with our other conversion-lifting plugins.<br>Act fast!</div>
                </div>
