...
class XLWCTY_Common {
	...
	public static function init() {
		 ...
		 * Loading XL core
		 */
		add_action( 'init', array( __CLASS__, 'xlwcty_xl_init' ), 8 );
		/**
	...
	public static function is_load_admin_assets( $cur_screen = 'single' ) {
		...
		if ( $cur_screen == 'all' ) {
			...
			if ( is_object( $screen ) && ( $screen->base == 'woocommerce_page_wc-settings' && isset( $_GET['tab'] ) && $_GET['tab'] == self::get_wc_settings_tab_slug() ) ) {
				return true;
			}
