<?php
/**
 * Plugin Name: WooCommerce Thank You Page - NextMove Lite
 ...
 *
 * WooCommerce Thank You Page - NextMove Lite is free software.
 * You can redistribute it and/or modify it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * any later version.
 *
 * WooCommerce Thank You Page - NextMove Lite is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with WooCommerce Thank You Page - NextMove Lite. If not, see <http://www.gnu.org/licenses/>.
 *
 * @package NextMove
 * @Category Core
 * @author XLPlugins
...
if ( ! class_exists( 'XLWCTY_Core' ) ) :
	...
	class XLWCTY_Core {
		...
		public function include_commons() {
			...
			require 'includes/xlwcty-common.php';
			require_once 'compatibilities/class-xlwcty-compatibilities.php';
			require 'includes/xlwcty-xl-support.php';
			require 'merge-tags/xlwcty-shortcode-merge-tags.php';
			require 'merge-tags/xlwcty-dynamic-merge-tags.php';
			require 'merge-tags/xlwcty-static-merge-tags.php';
			require 'includes/xlwcty-component.php';
			require 'includes/xlwcty-components.php';
		}
		...
		public function xlwcty_init() {
			if ( xlwcty_is_woocommerce_active() && class_exists( 'WooCommerce' ) ) {
				...
				require 'includes/xlwcty-data.php';
				require 'includes/xlwcty-themes-helper.php';

				if ( ! ( ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) ) || ! is_admin() ) {
					require 'includes/xlwcty-public.php';
				}
			}
		}
...
require 'includes/xlwcty-logging.php';
