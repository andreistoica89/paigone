...
<div class="xlwcty_Box xlwcty_Map">
    <div class="xlwcty_mapDiv xlwcty-map-component" data-address='<?php echo urlencode( $this->data->map_add ) ?>' data-zoom-level='<?php echo $default_zoom ?>' data-nm-icon="<?php echo urlencode( $this->data->icon ) ?>" data-style="<?php echo $this->data->style ? $this->data->style : "standard" ?>" data-marker-text="<?php echo urlencode( apply_filters( 'xlwcty_the_content', ( $this->data->marker_text ) ) ); ?>">
		<?php
